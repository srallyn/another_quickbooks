...
class _LineConverter implements JsonConverter<Line, Object?> {
  ...
  Line fromJson(Object? json) {
    if (json is Map<String, dynamic> && json.containsKey('DetailType')) {
...
class GroupLineDetail {
  ...
  GroupLineDetail({this.line, this.groupItemRef, this.quantity});
...
class DescriptionLineDetail {
  ...
  DescriptionLineDetail({this.serviceDate, this.taxCodeRef});
...
class SubtotalLineDetail {
  ...
  SubtotalLineDetail({this.itemRef});
...
class MarkupInfo {
  ...
  MarkupInfo({this.priceLevelRef, this.markUpIncomeAccountRef, this.percent});
...
class TxnTaxDetail {
  ...
  TxnTaxDetail({this.line, this.totalTax, this.txnTaxCodeRef});
...
class TaxLine {
  ...
  TaxLine({this.amount, required this.detailType, required this.taxLineDetail});
...
class TelephoneNumber {
  ...
  TelephoneNumber({this.freeFormNumber});
...
class CreditCardPayment {
  ...
  CreditCardPayment({this.creditChargeInfo, this.creditChargeResponse});
...
class EmailMessageType {
  ...
  EmailMessageType({this.message, this.subject});
...
class ReportPrefs {
  ...
  ReportPrefs({this.reportBasis, this.calcAgingReportFromTxnDate});
...
class TaxPrefs {
  ...
  TaxPrefs({this.partnerTaxEnabled, this.taxGroupCodeRef, this.usingSalesTax});
...
class CurrencyPrefs {
  ...
  CurrencyPrefs({this.homeCurrency, this.multiCurrencyEnabled});
...
class ProfitAndLoss {
  ...
  ProfitAndLoss({this.columns, this.header, this.rows});
...
class TransactionRows {
  ...
  TransactionRows({this.rows});

  factory TransactionRows.fromJson(Map<String, dynamic> json) =>
      _$TransactionRowsFromJson(json);

  Map<String, dynamic> toJson() => _$TransactionRowsToJson(this);
...
class ProfitColumn {
  ...
  ProfitColumn({this.colTitle, this.colType});
...
class TransactionColumn {
  ...
  TransactionColumn({this.colTitle, this.colType});

  factory TransactionColumn.fromJson(Map<String, dynamic> json) =>
      _$TransactionColumnFromJson(json);

  Map<String, dynamic> toJson() => _$TransactionColumnToJson(this);
...
class RowSummary {
  ...
  RowSummary({this.colData});

  factory RowSummary.fromJson(Map<String, dynamic> json) =>
      _$RowSummaryFromJson(json);

  Map<String, dynamic> toJson() => _$RowSummaryToJson(this);
...
/// The PurchaseOrder object is a non-posting transaction
/// representing a request to purchase goods or services
/// from a third party.
...
class PurchaseOrder {
  ...
  @JsonKey(name: "VendorAddr")
  final PhysicalAddress? vendorAddr;
...
class ContactInfo {
  ...
  ContactInfo({this.type, this.telephone});
...
class ZeroDollarVerification {
  ...
  ZeroDollarVerification({this.type, this.status, this.transactionId});
...
class CaptureDetail {
  ...
  CaptureDetail({this.context, this.description, this.amount, this.created});
...
class TransactionListQuery {
  ...
  final String? duedate_macro;

  final String? arpaid;

  final String? bothamount;

  final String? transaction_type;

  final String? docnum;

  final String? start_moddate;

  final String? source_account_type;
  ...
  final String? start_duedate;

  final String? columns;

  final String? end_duedate;
  ...
  final String? moddate_macro;

  final String? printed;

  final String? createdate_macro;
  ...
  final String? start_createdate;

  final String? end_moddate;

  factory TransactionListQuery.fromJson(Map<String, dynamic> json) =>
      _$TransactionListQueryFromJson(json);
...
class TransactionList {
  ...
  TransactionList({this.columns, this.header, this.rows});
...
class TransactionColumns {
  ...
  TransactionColumns({this.columns});

  factory TransactionColumns.fromJson(Map<String, dynamic> json) =>
      _$TransactionColumnsFromJson(json);

  Map<String, dynamic> toJson() => _$TransactionColumnsToJson(this);
...
///
/// The information below provides a reference on how to access
/// a generic report from the QuickBooks Online
/// Report Service.
///
@JsonSerializable(includeIfNull: false)
class Report {
  ...
  Report({this.header, this.columns, this.rows});
...
class ReportHeader {
  ...
  Map<String, dynamic> toJson() => _$ReportHeaderToJson(this);
...
class ReportRows {
  ...
  ReportRows({this.rows});

  factory ReportRows.fromJson(Map<String, dynamic> json) =>
      _$ReportRowsFromJson(json);

  Map<String, dynamic> toJson() => _$ReportRowsToJson(this);
...
class ReportRow {
  ...
  ReportRow({this.rows, this.header, this.colData, this.summary, this.type});

  factory ReportRow.fromJson(Map<String, dynamic> json) =>
      _$ReportRowFromJson(json);

  Map<String, dynamic> toJson() => _$ReportRowToJson(this);
...
class ReportColumn {
  ...
  ReportColumn({this.colType, this.colTitle});
...
enum GlobalTaxCalculationEnum { TaxExcluded, TaxInclusive, NotApplicable }

enum BillableStatusEnum { Billable, NotBillable, HasBeenBilled }

enum CustomFieldTypeEnum {
  StringType,
}

enum CCPaymentStatusEnum { Completed, Unknown }
